...
const formatDuration = (checkinTime, now) => {
  if (!checkinTime)
    return { hours: 0, minutes: 0, seconds: 0, display: "00:00:00" };
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
          ...
          <div className="rounded-xl bg-indigo-50 p-3">
            ...
            <div className="flex items-center gap-1 mt-0.5">
              ...
              />
              <span className="text-[10px] text-indigo-500 capitalize">
              ...
              {session.pricingTiers.map((tier, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={`text-[10px] font-bold uppercase tracking-wide mb-0.5 ${isActive ? "text-emerald-600" : "text-blue-500"}`}
                    >
                      {tier.tierLabel}
                    </span>
                    <span
                      className={`text-sm font-extrabold ${isActive ? "text-emerald-700" : "text-slate-800"}`}
                    >
