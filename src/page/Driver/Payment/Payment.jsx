...
const Payment = () => {
    ...
    const amount = currentSession?.currentAccumulatedFee ?? 0;
    ...
    useEffect(() => {
        if (currentSession && getProfileUser) {
            form.setFieldsValue(formDefaults);
        }
    }, [form, formDefaults, currentSession, getProfileUser]);

    const handleSubmit = (values) => {
        if (!currentSession) return;

        const payload = buildPaymentPayload(currentSession, getProfileUser, values.note);
        ...
        return (
            <div className="min-h-screen bg-[#f0f4ff] p-4 md:p-8">
                ...
                <div className="rounded-2xl border border-dashed border-gray-200 bg-white py-20">
                    ...
                    >
                        <Button type="primary" onClick={() => navigate("/driver/current-session")}>
    ...
    const isPaid = currentSession.paymentStatus === "PAID";
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <div className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
                    ...
                    <div className="rounded-2xl bg-gradient-to-br from-emerald-600 to-teal-700 p-6 text-white mb-4">
                        ...
                        {currentSession.currentFeeExplanation && (
                    ...
                    {isPaid ? (
                        ...
                        >
                            <Form.Item name="sessionId" label="sessionId">
                                <Input readOnly className="!bg-slate-50 !font-mono !text-slate-600" />
                            </Form.Item>
