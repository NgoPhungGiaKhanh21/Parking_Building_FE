...
const ExitHeader = () => (
  <div className="mb-6 rounded-2xl border border-orange-100 bg-white p-6 shadow-sm">
    ...
    <div className="flex items-center gap-4">
      <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-orange-200 bg-linear-to-br from-orange-50 to-amber-50 text-orange-600">
